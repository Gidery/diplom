            ...
            <div className={styles.Main}>
                <div className={styles.Form}>
                    ...
                    <div className={styles.PassportInputs}>
                        <Input value={rbo.passportData.series} onChange={(e: ChangeEvent<HTMLInputElement>) => onSetPassportData('series', e.target.value)}/>
                        <Input value={rbo.passportData.number} onChange={(e: ChangeEvent<HTMLInputElement>) => onSetPassportData('number', e.target.value)}/>
                    </div>
